...
const tshirts = [
  ...
  { id: 5, name: "Tommy Hilfiger Teal Polo", price: "₹2,000", oldPrice: "₹3,500", discount: "14% off", image: TommyTeal },
  { id: 6, name: "Tommy Hilfiger Off-white", price: "₹3,100", oldPrice: "₹3,600", discount: "14% off", image: TommyOffwhite },
  { id: 7, name: "Tommy Hilfiger Navy Polo", price: "₹2,200", oldPrice: "₹3,700", discount: "14% off", image: TommyNavy },
  ...
  { id: 11, name: "Ralph Lauren Polo Mustard Shirt", price: "₹2,450", oldPrice: "₹4,100", discount: "16% off", image: RalphMustard },
  { id: 12, name: "Ralph Lauren Polo Black Shirt", price: "₹2,500", oldPrice: "₹4,200", discount: "17% off", image: RalphBlack },
  { id: 13, name: "Ralph Lauren Cotton Wine Shirt", price: "₹2,550", oldPrice: "₹4,300", discount: "17% off", image: RalphWine },
  { id: 14, name: "Ralph Lauren Cotton White Shirt", price: "₹2,600", oldPrice: "₹4,350", discount: "17% off", image: RalphWhite },
  { id: 15, name: "Ralph Lauren Cotton Milange Shirt", price: "₹1,650", oldPrice: "₹4,400", discount: "17% off", image: RalphMilange },
  ...
  { id: 18, name: "Lacoste White Shoulder Strip Polo", price: "₹2350", oldPrice: "₹4,050", discount: "17% off", image: LacosteWhite2 },
  { id: 19, name: "Lacoste Sky Premium Polo", price: "₹2,400", oldPrice: "₹4,100", discount: "17% off", image: LacosteSky },
  { id: 20, name: "Lacoste Offwhite Premium Polo", price: "₹2,450", oldPrice: "₹4,150", discount: "17% off", image: LacosteOffwhite },
  { id: 21, name: "Lacoste Navy Premium Polo", price: "₹2,500", oldPrice: "₹4,200", discount: "17% off", image: LacosteNavy },
  { id: 22, name: "Lacoste Maroon Premium Polo", price: "₹2,550", oldPrice: "₹4,250", discount: "17% off", image: LacosteMaroon },
  { id: 23, name: "Lacoste Black Premium Polo", price: "₹1,600", oldPrice: "₹4,300", discount: "17% off", image: LacosteBlack },
  { id: 24, name: "Lacoste Beige Premium Polo", price: "₹1,650", oldPrice: "₹4,350", discount: "16% off", image: LacosteBeige },
  { id: 25, name: "Gucci White Premium T-Shirt", price: "₹1,000", oldPrice: "₹4,600", discount: "13% off", image: GucciWhite },
  { id: 26, name: "Gucci Monogram White Shirt", price: "₹1200", oldPrice: "₹4,800", discount: "12% off", image: GucciWhiteShirt },
  { id: 27, name: "Gucci Monogram Black Shirt", price: "₹1,250", oldPrice: "₹4,900", discount: "13% off", image: GucciBlackShirt1 },
  { id: 28, name: "Gucci Black Premium T-Shirt", price: "₹1,350", oldPrice: "₹5,000", discount: "13% off", image: GucciBlackTshirt },
  { id: 29, name: "Gucci Beige Premium T-Shirt", price: "₹1,400", oldPrice: "₹5,050", discount: "13% off", image: GucciBeigeTshirt },
  { id: 30, name: "Dolce & Gabbana White Premium Shirt", price: "₹1,500", oldPrice: "₹5,200", discount: "13% off", image: DolceWhite },
  { id: 31, name: "Dolce & Gabbana Black Premium Shirt", price: "₹1,550", oldPrice: "₹5,250", discount: "13% off", image: DolceBlack1 },
  { id: 32, name: "Christian Dior White Premium Shirt", price: "₹1,700", oldPrice: "₹5,400", discount: "13% off", image: DiorWhite },
];

...
import CustomModal from "../Sidebar/CustomModal"; // ✅ Import your modal
...
const menshoesList = menshoes.map((menshoe) => ({
  ...menshoe,
  price: menshoe.price + priceIncrement,
}));
...
const Menshoes = () => {
  ...
  const confirmPurchase = () => {
    ...
    navigate("/customer-details", { state: { product: selectedShoe } }); // ✅ Pass selected product
  };
